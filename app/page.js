...
export default function Home() {
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 p-20 gap-16 sm:p-20">
      ...
      <p className="text-lg text-gray-100 mb-2">Elige y compra tus hamburguesas favoritas de manera fácil y rápida.</p>
      <p className="text-base text-gray-100">Disfruta de una experiencia sencilla, rápida y segura. ¡Explora nuestro menú y haz tu pedido ahora!</p>
